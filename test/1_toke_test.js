...
contract('StandardToken', function (accounts) {
    ...
    beforeEach(async function () {
      this.token = await  ESTToken.new(91000000000000000, "Era Swap Token", "EST");
    });
    ...
    describe('total supply', function () {
      it('returns the total amount of tokens', async function () {
        ...
        assert.equal(totalSupply, 91000000000000000);
      });
    });
    ...
    describe('balanceOf', function () {
      ...
      describe('when the requested account has some tokens', function () {
        it('returns the total amount of tokens', async function () {
          ...
          assert.equal(balance, 91000000000000000);
        });
      });
    });
    ...
    describe('transfer', function () {
      describe('when the recipient is not the zero address', function () {
        ...
        describe('when the sender has enough balance', function () {
          const amount = 91000000000000000;
      ...
      describe('transfer from', function () {
        ...
        describe('when the recipient is not the zero address', function () {
          ...
          describe('when the spender has enough approved balance', function () {
            beforeEach(async function () {
              await this.token.approve(spender, 91000000000000000, { from: accounts[0] });
            });
      ...
      describe('burn', function () {
        ...
        describe('when the given amount is not greater than balance of the sender', function () {
          ...
          it('burns the requested amount', async function () {
              ...
              const { logs } = await this.token.burn({ from });
